        ...
        <section className="py-20 px-4 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            {categorias.map((cat) => (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-[var(--color-bege)] flex items-center justify-center text-2xl overflow-hidden relative">
                  {cat.imagemUrl ? (
                    <Image src={cat.imagemUrl} alt={cat.nome} fill className="object-cover" />
                  ) : (
                    <span>{iconesCategorias[cat.slug.toLowerCase()] ?? iconesCategorias.default}</span>
                  )}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={passo.num} className="flex flex-col items-center gap-4 p-6">
                ...
                <div className="text-3xl">{passo.icone}</div>
